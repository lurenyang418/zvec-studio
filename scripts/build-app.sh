...
cp -R "$BIN_DIR/ZvecStudio_ZvecStudio.bundle" "$RESOURCES/ZvecStudio_ZvecStudio.bundle"
cp -R "$ROOT/Sources/ZvecStudio/Resources/en.lproj" "$RESOURCES/en.lproj"
cp -R "$ROOT/Sources/ZvecStudio/Resources/zh-Hans.lproj" "$RESOURCES/zh-Hans.lproj"
